...
ARG = ""
count =0
descriptors_file = "plumed-driver.dat" # "plumed-descriptors.dat", "plumed-driver.dat"
...
for i in range(1,iterations):
    ...
    with open(folder+"plumed.dat","w") as file:
        ...
        opes: OPES_METAD ARG=tica_cv1_"""+str(i-1)+""",tica_cv2_"""+str(i-1)+""" TEMP=340 BIASFACTOR=5 PACE=500 RESTART=NO FILE=KERNELS BARRIER="""+str(BARRIER)+""" STATE_WFILE=RestartKernels STATE_WSTRIDE=500*10  
