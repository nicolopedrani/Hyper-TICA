...
def tica_load(temp=1.0,path="colvar.data",descriptors="^p.",reweighting=True):
    ...
    return data,logweight,X,t,names

def training(temp,path,train_parameters,tprime=None):

    data,logweight,X,t,names = tica_load(temp=temp,path=path,descriptors=train_parameters["descriptors"],
